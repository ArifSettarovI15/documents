    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <form class="custom_invoice_create_form" action="{{route('manager.invoices.create_custom_invoice')}}">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" data-default="" class="form-control" required name="invoice_contract" id="invoice_contract">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input data-default="{{$info->client_name}}" class="form-control" required type="text" value="{{$info->client_name}}" name="client_name" id="client_name">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="client_phone" >Телефон:</label>
                            <input class="form-control" data-default="{{$info->client_phone}}" required type="text" value="{{$info->client_phone}}" name="client_phone" id="client_phone">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="client_address">Адрес:</label>
                            <input class="form-control" required type="text"  data-default="{{$info->client_address}}" value="{{$info->client_address}}" name="client_address" id="client_address">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="client_inn" >ИНН (или паспортные данные):</label>
                            <input class="form-control"
                                   @if ($info->client_type != 'fiz')
                                   data-default="{{$info->client_inn}}"
                                    value="{{$info->client_inn}}"
                                   @else
                                   data-default="{{$info->client_passport}} Выдан {{$info->client_passport_issuset}} {{$info->client_passport_date}}"
                                    value="{{$info->client_passport}} Выдан {{$info->client_passport_issuset}} {{$info->client_passport_date}}"
                                   @endif

                                   required type="text" name="client_inn" id="client_inn">
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="form-row services_data_wrapper">
                        <div class="form-group col-md-6">
                            ...
                            <select name="service_names[]" data-default="{{$services_select[0]->service_writen}}" required class="form-control service_names_selector" id="service_names">
                                @foreach($services_select as $service)
                            ...
                            <div style="display: none" class="service_names_selector_wrapper">
                                <input type="text"  required disabled class="form-control service_names_selector" id="service_names" name="service_names[]">
                                <span class="icon_down service_names_selector_icon" ><i class="fa fa-angle-down"></i></span>
                            </div>
                        </div>
                        <div class="form-group col-md-5">
                            <input type="number" data-default="" required class="form-control service_prices" id="service_prices" name="service_prices[]">
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control datepicker" required data-default="{{date('d.m.Y')}}" value="{{date('d.m.Y', time())}}" type="text" id="invoice_date" name="invoice_date" >
                        </div>
                        <div class="form-group col-md-6">
            ...
            <div class="modal-footer">
                <button type="submit" data-target="#create_custom_invoice_and_send" class="btn btn-outline-success create_custom_invoice_and_send">Отправить счет</button>
