...
<div class="container h-100 d-flex justify-content-center">
    <div class="jumbotron my-auto" style="margin: 0;padding: 0; background: none;">
        <div class="col-md-offset-3 col-md-6" style="  padding-top: 10px;padding-bottom: 10px;">
            <form class="form-horizontal" action="{{route('user.forgot')}}" style="padding: 20px; width: 470px;margin: 10px;" method="POST">
                <span class="heading">ВОССТАНОВЛЕНИЕ</span>
                <div class="form-group help">
                    <input type="password" class="form-control" id="inputPassword" name="password"  placeholder="Новый пароль">
                ...
                @if($id)
                    <input type="hidden" class="form-control" id="inputPassword" name="id" value="{{$id}}">
                @endif
